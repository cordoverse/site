const Hero = () => {
  return (
    <div class="flex h-screen flex-col items-center justify-center p-5 bg-[url('/images/bg-cv.png')]">
      ...
      <a class="rounded-lg bg-[#70d0c8] py-2 px-5 text-3xl font-bold" href="https://www.eventbrite.com.ar/e/registro-cordoverse-community-meet-up-v1-307898943027?aff=Sitioweb" target="_blank">
        Quiero ir!
      </a>
    </div>
  )
